...
span.innerHTML = span.innerHTML + 'Tomas Garnero';
//----------------------------------------------------------------------------------------------------------
...
function buildToDos(toDos) {
  // toDos = [{Comprar tomate, complete}, {Comprar lechuga, complete}, {Comprar cebolla, complete}]
  //   i                     0                            1                            2

  // let newArray = toDos.map(function(todo, i) {
  //   return buildToDo(todo, i);
  // });

  // return newArray;

  // newArray = [<div class="toDoShell"><span id=0>Comprar tomate</span></div>, 
  //             <div class="toDoShell"><span id=1>Comprar lechuga</span></div>, 
  //             <div class="toDoShell"><span id=2>Comprar cebolla</span></div>]

  return toDos.map(buildToDo); // buildToDo(todo, i)
}
//---------------------------------------------------------------------------------------------------------------------
...
function displayToDos() {
  ...
  // build = [<div class="toDoShell"><span id=0>d</span></div>, 
  //          <div class="toDoShell"><span id=1>d</span></div>, 
  //          <div class="toDoShell"><span id=2>d</span></div>]

  //                                              Otra forma seria con:
  for (let i = 0; i < build.length; i++) {     // build.forEach(function(e){return toDoContainer.appendChild(e)})
    toDoContainer.appendChild(build[i]);
  }
  // <div id="toDoContainer">
  //   <div class="toDoShell"><span id=0>d</span></div>
  //   <div class="toDoShell"><span id=1>d</span></div>
  //   <div class="toDoShell"><span id=2>d</span></div>
  // </div>
}
...
function addToDo() {
  ...
  if (input.value !== "") {
    ...
    toDoItems.push(toDo);                    // actualice mi array de toDos
    input.value = "";
    displayToDos();                          // se encarga de que aparezca en pantalla el nuevo elemento, en realidad
  }                                          // se vuelve a renderizar / mostrar todos de nuevo
}
//----------------------------------------------------------------------------------------------------------------------
...
function completeToDo(event) {
  ...
  // event - click
  // event.target - span
  // event.target.id - index buildToDo o el index del span
